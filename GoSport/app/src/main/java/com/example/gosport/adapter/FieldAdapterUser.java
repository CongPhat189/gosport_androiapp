...
public class FieldAdapterUser extends BaseAdapter {

    Context context;
    ArrayList<FieldModel> list;
    ArrayList<FieldModel> originalList;

    public FieldAdapterUser(Context context, ArrayList<FieldModel> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context)
                    .inflate(R.layout.item_field_user, parent, false);
        }
